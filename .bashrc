...
alias win32cc='i686-w64-mingw32-gcc'
alias win64cc='x86_64-w64-mingw32-gcc'
alias whereami='pwd'
...
# export PS1="\u@\h \[\e[01;32m\]\w \[\e[01;91m\]\$(parse_git_branch)\[\e[01;00m\]$ "
export PS1="\[\e[01;33m\]\u@\h \[\e[01;32m\]\w \[\e[01;91m\]$(parse_git_branch)\[\e[01;00m\]\n\[\e[01;33m\]$ \[\e[01;32m\]"
...
set_prompt() {
  ...
  local ex=$?
# Set prompt content
  PS1="\[\e[01;33m\]\u@\h \[\e[01;32m\]\w \[\e[01;91m\]$(parse_git_branch)\[\e[01;00m\]\n\[\e[01;33m\]$ \[\e[01;32m\]"
  # If exit code of last command is non-zero, prepend this code to the prompt
  [[ "$ex" -ne 0 ]] && PS1="\[\e[01;34m\]exit code: $ex\n$PS1"
}
